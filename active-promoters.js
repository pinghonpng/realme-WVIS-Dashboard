...
(()=>{
 ...
 async function check(){
  ...
  try{
   ...
   roster=next;lastChecked=new Date();$('rosterStatus').textContent=next.count+' ACTIVE promoters · Last checked '+lastChecked.toLocaleString();renderPromoters(state.filteredSales);decorate();
 ...
 window.evisRoster={setConfig,setAdmin:(allowed)=>{['rosterUrl','rosterTab','rosterSave'].forEach(id=>$(id).disabled=!allowed);}};
