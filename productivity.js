...
(()=>{
 ...
 function renderProductivity(){
  ...
  const label={area:'Area',subregion:'Area / Subregion',dealer:'Dealer'}[view],header=$('productivityGroupHeader'),button=header.querySelector('.table-sort-button');if(button){button.setAttribute('aria-label','Sort by '+label);button.textContent=label+({'ascending':' ↑','descending':' ↓'}[header.getAttribute('aria-sort')]||' ↕');}else header.textContent=label;
